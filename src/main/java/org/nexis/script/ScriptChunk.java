...
import static org.nexis.script.ScriptOpCodes.getOpCodeName;
import static org.nexis.script.ScriptOpCodes.getPushDataName;
...
//    @Nullable
    ...
    /**
     * If this chunk is a single byte of non-pushdata content (could be
     * OP_RESERVED or some invalid Opcode)
     */
    ...
    /**
     * Called on a pushdata chunk, returns true if it uses the smallest possible
     * way (according to BIP62) to push the data.
     */
