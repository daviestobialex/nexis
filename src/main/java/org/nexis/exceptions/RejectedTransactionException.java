...
import org.nexis.core.RejectMessage;
import org.nexis.core.Transaction;

/**
 * This exception is used by the TransactionBroadcast class to indicate that a
 * broadcast Transaction has been rejected by the network, for example because
 * it violates a protocol rule. Note that not all invalid transactions generate
 * a reject message, and some peers may never do so.
 */
