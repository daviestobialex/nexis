...
import org.nexis.base.utils.Fiat;

import static org.nexis.internal.Preconditions.checkArgument;

/**
 * An exchange rate is expressed as a ratio of a {@link Coin} and a {@link Fiat}
 * amount.
 */
public class ExchangeRate {
     ...
     * @param convertCoin
     * @return
     * @throws ArithmeticException if the converted fiat amount is too high or
     * too low.
     */
     ...
     * @param convertFiat
     * @return
     * @throws ArithmeticException if the converted coin amount is too high or
     * too low.
     */
