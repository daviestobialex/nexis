...
/**
 * A UTXOProvider encapsulates functionality for returning unspent transaction
 * outputs, for use by the wallet or other code that crafts spends.
 *
 * <p>
 * A {@link FullPrunedBlockStore} is an internal implementation within
 * bitcoinj.</p>
 */
public interface UTXOProvider {
     ...
     */
    List<UTXO> getOpenTransactionOutputs(List<PublicKey> keys) throws UTXOProviderException;
