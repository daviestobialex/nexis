...
/**
 * Represents the results of a {@link CoinSelector#select(Coin, List)}
 * operation. A coin selection represents a list of spendable transaction
 * outputs that sum together to a {@link #totalValue()} value gathered.
 * Different coin selections could be produced by different coin selectors from
 * the same input set, according to their varying policies.
 */
