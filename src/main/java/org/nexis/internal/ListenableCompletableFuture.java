...
/**
 * A {@link CompletableFuture} that is also a
 * {@link com.google.common.util.concurrent.ListenableFuture} for migration from
 * Guava {@code ListenableFuture} to {@link CompletableFuture}.
 */
public class ListenableCompletableFuture<V> extends CompletableFuture<V> implements ListenableCompletionStage<V> {
     ...
     * the given value.
     * <p>
     * When the migration to {@link CompletableFuture} is finished use of this
    ...
    /**
     * Returns a new {@link ListenableCompletableFuture} that is already
     * completed exceptionally with the given throwable.
     * <p>
     * When the migration to {@link CompletableFuture} is finished this can be
     * deprecated and {@link FutureUtils#failedFuture(Throwable)} can be used
     * instead.
     *
    ...
    /**
     * Converts a generic {@link CompletableFuture} to a
     * {@code ListenableCompletableFuture}. If the passed in future is already a
     * {@code ListenableCompletableFuture} no conversion is performed.
     * <p>
     * When the migration to {@link CompletableFuture} is finished usages of
     * this method can simply be removed as the conversion will no longer be
     * required.
     *
