...
public class AddressFormatException extends IllegalArgumentException {
     ...
     * {@code EncodedPrivateKey} hierarchy of classes when you try to decode
     * data and a character isn't valid. You shouldn't allow the user to proceed
     * in this case.
     */
     ...
     * This exception is thrown by {@link Base58}, {@link Bech32} and the
     * {@code EncodedPrivateKey} hierarchy of classes when you try to decode
     * data and the data isn't of the right size. You shouldn't allow the user
     ...
     * This exception is thrown by {@link Base58}, {@link Bech32} and the
     * {@code EncodedPrivateKey} hierarchy of classes when you try to decode
     * data and the checksum isn't valid. You shouldn't allow the user to
    ...
    /**
     * This exception is thrown by {@code SegwitAddress} when you try to decode
     * data and the witness version doesn't match the Bech32 encoding as per
     * BIP350. You shouldn't allow the user to proceed in this case.
     */
    ...
    /**
     * This exception is thrown by the {@code EncodedPrivateKey} hierarchy of
    ...
    /**
     * This exception is thrown by the {@code EncodedPrivateKey} hierarchy of
     * classes when you try and decode an address with a prefix (version header
     * or human-readable part) that used by another network (usually: mainnet vs
     * testnet). You shouldn't allow the user to proceed in this case as they
     * are trying to send money across different chains, an operation that is
     * guaranteed to destroy the money.
     */
