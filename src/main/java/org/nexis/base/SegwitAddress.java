...
public class SegwitAddress implements Address {
    ...
    /**
     * Human-readable part (HRP) of Segwit addresses for standard Bitcoin
     * networks.
     * <p>
     * See
     * <a href="https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki#user-content-Segwit_address_format">BIP
     * 173 definition of {@code bc} and {@code tb} HRPs</a> and
     * <a href="https://github.com/bitcoin/bitcoin/issues/12314">Bitcoin Core
     * Issue 1234 - discussion of {@code bcrt} HRP</a> for details.
     */
    public enum SegwitHrp {
        ...
        SegwitHrp(NexusNetwork n) {
            networks = EnumSet.of(n);
        }

        SegwitHrp(NexusNetwork n1, NexusNetwork n2) {
            networks = EnumSet.of(n1, n2);
        }

        /**
         * Get the HRP in lowercase. To get uppercase, use
         * {@link SegwitHrp#name()}
         *
        ...
        /**
         * @param hrp uppercase or lowercase HRP
         * @return Optional containing the corresponding enum or empty if not
         * found
         */
         ...
         * @return the corresponding enum
         */
        public static SegwitHrp ofNetwork(NexusNetwork network) {
     ...
     * @param witnessProgram hash of pubkey, pubkey or script (depending on
     * version) (8-bits per byte)
    ...
    /**
     * Returns the witness version in decoded form. Only versions 0 and 1 are in
     * use right now.
     *
     ...
     * address. This is either {@link ScriptType#P2WPKH} or
     * {@link ScriptType#P2WSH}.
     *
     ...
     * @throws AddressFormatException if something about the given bech32
     * address isn't right
     */
    public static SegwitAddress fromBech32(String bech32,
            //            @Nonnull 
            Network network)
    ...
    static SegwitAddress fromBechData(
            //            @Nonnull 
            Network network, Bech32.Bech32Data bechData) {
    ...
    /**
     * Construct a {@link SegwitAddress} that represents the given hash, which
     * is either a pubkey hash or a script hash. The resulting address will be
     * either a P2WPKH or a P2WSH type of address.
     *
     * @param network network this address is valid for
    ...
    /**
     * Construct a {@link SegwitAddress} that represents the given program,
     * which is either a pubkey, a pubkey hash or a script hash – depending on
     * the script version. The resulting address will be either a P2WPKH, a
     * P2WSH or a P2TR type of address.
     *
     * @param network network this address is valid for
     * @param witnessVersion version number between 0 and 16
    ...
    /**
     * Get the network this address works on. Use of {@link BitcoinNetwork} is
     * preferred to use of {@link NetworkParameters} when you need to know what
     * network an address is for.
     *
     * @return the Network.
     */
    @Override
    ...
    public int compareTo(Address o) {
        // TODO: Need to expand more on what this means
        return Arrays.compare(getHash(), o.getHash());
    }
