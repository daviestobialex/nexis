...
public final class MonetaryFormat {
     ...
     * {@link #repeatOptionalDecimals(int, int)}), the value will be
     ...
     *
     * <p>
     * For example, if you pass {@code 4,2} it will add four decimals to your
     ...
     *
     * <p>
     * For example, if you pass {@code 1,8} it will up to eight decimals to your
     * formatted string if needed. After these have been used up, rather than
     * adding further decimals the value will be rounded.
     * </p>
     *
    ...
    /**
     * Separator between currency code and formatted value.This configuration is
     ...
     * @param decimalShift the number of places to move the decimal point to the
     * left, coming from smallest unit (e.g. satoshi)
     * @param maxVisibleDecimals the maximum number of decimals that can be
     * visible in the formatted string
     ...
     *
     * @throws NumberFormatException if the string cannot be parsed for some
     * reason
     */
