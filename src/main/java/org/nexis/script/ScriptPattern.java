...
import static org.nexis.script.Script.decodeFromOpN;
...
public class ScriptPattern {
    ...
    public static boolean isP2PKH(Script script) {
        ...
        if (chunk2data == null)
            return false;
//        if (chunk2data.length != LegacyAddress.LENGTH)// plan not to support
//            return false;
    ...
    public static boolean isP2SH(Script script) {
        ...
        if (chunk1data == null)
            return false;
//        if (chunk1data.length != LegacyAddress.LENGTH)// plan not to support
//            return false;
